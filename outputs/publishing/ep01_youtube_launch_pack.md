# EP01 YouTube Launch Pack

## Primary Recommendation

Use YouTube as the first public launch platform.
Primary goal this week:
- get clicks
- get listening time
- get comments
- get language from real viewers
...
### Short 1
- Use Clip 1 from `outputs/clips/ep01_clips.md`
- Publish same day as long video or within 6 hours

### Short 2
- Use Clip 2 from `outputs/clips/ep01_clips.md`
- Publish within 24 hours of main upload
...
### Day 2
- Publish second Short
- Reply to every real comment
- Note which words viewers use most

### Day 3
- Decide next video based on comments, not instinct

## Metrics To Watch First

Only watch these in the first 72 hours:
- click-through rate
...
Do not spend extra time polishing low-impact details if the video is ready to publish.
The purpose of this upload is learning, not perfection.
